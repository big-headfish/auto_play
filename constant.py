...
train_chi_path = r'images/train_chi'
...
### image/train_chi ocr训练
# train_ocr_path = os.path.join(train_chi_path, )

### jianianhua_task_path 自动截图
...
### 获取截图名称
def get_crop_name(i):
    return os.path.join(jianianhua_task_path,i + '.png')
